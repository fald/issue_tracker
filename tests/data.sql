...
VALUES
    ...
    (1, 'Auth issues', 'Auth module does not work and is not required to edit issues.', 2, 3, 'Open', 'Medium', CURRENT_TIMESTAMP),
    (2, 'No project outline', 'No one knows what the expectations or final product are!!!', 3, null, 'Open', 'High'),
    (3, 'FOV System broken', 'Not intended to work with hex-grid.', 1, 1, 'Open', 'Low');
